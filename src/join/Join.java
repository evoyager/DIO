...
//        if (SetsAreEquals) System.out.println("SETS ARE EQUALS!");
    ...
    public ArrayList<Person> rightJoin(ArrayList<Person> leftArray, ArrayList<Person> rightArray) {
    ...
    public HashSet<Person> merge(ArrayList<Person> leftArray, ArrayList<Person> rightArray){
